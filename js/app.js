(() => {
    ...
    (() => {
        ...
        const priceSlider = document.querySelector(".navigation-products__range");
        ...
        function initSliders() {
            bildSliders();
            if (document.querySelector(".mind__slider")) new core(".mind__slider", {
                ...
                navigation: {
                    prevEl: ".mind__arrow_left",
                    nextEl: ".mind__arrow_right"
                },
                on: {}
            });
            if (document.querySelector(".image-detail__slider")) new core(".image-detail__slider", {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
